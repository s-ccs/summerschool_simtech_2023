...
Please download the files {{< downloadthis Manifest.toml label="Manifest.toml" >}} and {{< downloadthis Project.toml label="Project.toml" >}}, put the files in the same folder that \*.ipynb file is located.
